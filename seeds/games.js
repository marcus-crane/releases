  ...
  return knex('games').del()
    .then(function () {
      return Promise.all([
        ...
        knex('games').insert({ id: 4, gb_id: '3030-54211', title: 'Prey 2', description: 'An entirely new game from Arkane and Bethesda.', boxart: '/img/boxart/prey.jpg', bgcover: '/img/bgcover/prey.jpg', developer: 'Arkane Studios', publisher: 'Bethesda Softworks', releaseQuarter: 'Q1/Q2', releaseYear: 2017 }),
        knex('games').insert({ id: 5, gb_id: '3030-43972', title: 'Gravity Rush 2', description: 'A follow-up to one of Vita\'s most acclaimed original games.', boxart: '/img/boxart/gravity_rush_2.jpg', bgcover: '/img/bgcover/gravity_rush_2.jpg', developer: 'SIE Japan Studio', publisher: 'Sony Interactive', releaseDay: 20, releaseMonth: 'January', releaseYear: 2017 })
      ]);
    });
}
